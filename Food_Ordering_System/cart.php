...
<td>&#8377; <?php echo $values["food_offer_price"]; ?></td>
<td>&#8377; <?php echo number_format($values["food_quantity"] * $values["food_offer_price"], 2); ?></td>
<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>"><span class="text-danger">Remove</span></a></td>
</tr>
<?php 
$total = $total + ($values["food_quantity"] * $values["food_offer_price"]);
}
?>
<tr>
...
'food_offer_price' => $_POST["hidden_offer_price"],

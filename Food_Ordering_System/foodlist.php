...
<html>
  ...
  <head>
    <title> Explore | Food Finder </title>
  </head>
...
*/
//$offer_sql = "SELECT offer.offer_price FROM OFFER,FOOD WHERE OFFER.F_ID = FOOD.F_ID ORDER BY F_ID";
//$offer_result = mysqli_query($conn,$offer_sql);
//$offer_results = mysqli_fetch_array($offer_result,MYSQLI_BOTH);
//$offer_price = $offer_results['offer_price'];

//$F_namesql = "SELECT FOOD.name From FOOD,OFFER WHERE FOOD.F_ID = OFFER.F_ID ";
//$F_nameresult = mysqli_query($conn,$F_namesql);
//$F_names = mysqli_fetch_array($F_nameresult,MYSQLI_BOTH);
//$F_name = $F_names['name']; 
...
<h5 class="text-info"><?php $name = $row["name"]; echo $row["name"]; ?></h5>
<h5 class="text-info"><?php echo $row["description"]; ?></h5>
<h5 class="text-danger">&#8377; <?php $price = $row["price"];echo $row["price"]; ?>/-</h5>
<h5 class="text-danger">&#8377; Offer Price:<?php $price = $row["offer_price"];echo $row["offer_price"]; ?>/-</h5>
<h5 class="text-info">Quantity: <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
<input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>">
<input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>">
<input type="hidden" name="hidden_offer_price" value="<?php echo $row["offer_price"]; ?>">

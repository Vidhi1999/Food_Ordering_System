<html>
  ...
  <head>
    <title> Guest Signup | Food Finder </title>
  </head>
 ...
 margin: 0; padding: 0; font-size: small; color: #333;
  ...
  background-image:url("https://www.dominos.co.in/files/items/choco-lava-cake-771.jpg");
  background-repeat:no-repeat;
  
  background-size:140% 165%;   
}
  </style>
  <body>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="firstname" type="text" name="firstname" placeholder="Your First Name" required="" autofocus="">
         ...
         <div class="row">
          <div class="form-group col-xs-12">
            <label for="fullname"><span class="text-danger" style="margin-right: 5px;">*</span> Middle Name: </label>
            <div class="input-group">
              <input class="form-control" id="middlename" type="text" name="middlename" placeholder="Your Middle Name" required="" autofocus="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                </span>
              </span>
         ...
         <div class="row">
          <div class="form-group col-xs-12">
            <label for="fullname"><span class="text-danger" style="margin-right: 5px;">*</span> Last Name: </label>
            <div class="input-group">
              <input class="form-control" id="lastname" type="text" name="lastname" placeholder="Your Last Name" required="" autofocus="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                </span>
              </span>

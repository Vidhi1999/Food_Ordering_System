...
<h2 class="text-center"> Thank you for shopping at Food Finder! The ordering process is now complete.</h2>
...
<?php 
  ...
  $opt=$_GET['id'];
   ...
   // $total = $_SESSION['total_amt'];
     $sql="INSERT into payment(type,total,pdate) VALUES('$opt',$total,'$pdate')";
     $succ=$conn->query($sql);
      $numsql = "INSERT into delivery(ddate) VALUES('$pdate')";
       $success = $conn->query($numsql);
 ...
 // $type = "COD";
       ...
       //$query = "INSERT INTO payment(payment_no,pdate,total,type 
              //VALUES ('" . $number. "','" . $pdate. "','" . $total . "','" . $type. "')";

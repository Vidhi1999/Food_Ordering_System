...
$offer_price = $conn->real_escape_string($_POST['offer_price']);
...
$query = "INSERT INTO FOOD(name,price,offer_price,description,R_ID,images_path) VALUES('" . $name . "','" . $price . "','" . $offer_price . "','" . $description . "','" . $R_ID ."','" . $images_path . "')";
$success = $conn->query($query);

$F_IDsql = "SELECT FOOD.F_ID FROM FOOD, RESTAURANTS WHERE RESTAURANTS.R_ID = FOOD.R_ID AND FOOD.name = '$name' ";
$F_IDresult = mysqli_query($conn,$F_IDsql);
$F_IDrs = mysqli_fetch_array($F_IDresult,MYSQLI_BOTH);
$F_ID = $F_IDrs['F_ID'];
//$query1 = "INSERT INTO OFFER(R_ID,F_ID,offer_price) VALUES('" . $R_ID . "','" . $F_ID . "','" . $offer_price . "')";

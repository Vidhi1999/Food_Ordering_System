...
<html>
  ...
  <head>
    <title> Manager Login | Food Finder </title>
  </head>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    description='$description', offer_price='$offer_price' where F_ID='$F_ID'");

     //$query2 = mysqli_query($conn, "UPDATE offer o set o.offer_price = '$offer_price' where o.F_ID = '$F_ID' ");
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM food f WHERE f.F_ID=$update  " );
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Food Offer Price: </label>
            <input type="text" class="form-control" id="offer_price" name="offer_price" value=<?php echo $row1['offer_price'];  ?> placeholder="Your Food Offer Price (INR)" required="">
          </div>

...
<html>
  ...
  <head>
    <title> Online Payment | Food Finder </title>
  </head>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <?php $gtotal=$_GET['total'];?>
                              <form method="post" action="COD.php?action=pay&id=<?php echo "onlinepay"; ?>&total=<?php echo $gtotal?>"><button class="btn btn-success btn-block" required="" />PAY NOW</button></form>  
                            </div>
                        </div>

...
$query = "INSERT into CUSTOMER(username,first_name,middle_name,last_name,email,contact,address,password) VALUES('" . $username . "','" . $first_name ."','" . $middle_name ."','" . $last_name . "','" . $email . "','" . $contact . "','" . $address ."','" . $password ."')";

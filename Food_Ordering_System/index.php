...
?>
    ...
    <div class="wide">
        ...
        <div class="col-xs-5 line"><hr></div>
        <div class="tagline">Every Bite takes you Home</div>
    </div>
    <br>
    ...
    <div class="paragraph1">
     <h1>Food Finder - Every Bite takes you Home</h1>
    <p><br> 
      <h4>
      Food Finder will help in making your quest for enjoying good lunch, dinner which is are home delivered all the more interesting and excited when you are scartching your head to entertain your guest with their demands met.
      </h4>
    </p>
    <p>
      <h4>
        There are two ways you can <font color="green"><strong>order food online</strong></font> with us. <font color="green"><strong>Download Food Finder app on your smartphone</strong></font> or open our user friendly website and get it home delivered. Or if you are busy in your schedule and just want to eat at leisure at home you can order takeaway from host of restaurants and pickup the food parcel kept ready for you while you are on the way to home.
      </h4>
    </p>
    </div>
    ...
    <div class="paragraph1">
          ...
          <p>
            <h3>
              <span class="glyphicon glyphicon-ok tickicon"></span> <u>LOGIN TO YOUR ACCOUNT OR CREATE YOUR ACCOUNT</u>
            </h3>
          </p>
          <p>
            <h4>
          ...
          <p>
            <h3>
              <span class="glyphicon glyphicon-ok tickicon"></span> <u>SELECT YOUR FOOD ITEMS</u>
            </h3>
          </p>
          <p>
            <h4>
          ...
          <p>
            <h3>
              <span class="glyphicon glyphicon-ok tickicon"></span> <u>AFTER CHOOSING PAY ONLINE/OFFLINE</u>
            </h3>
          </p>
          <p>
            <h4>
          ...
          <p>
            <h4>
              Yes, Food Finder is another way to live life with our loved ones...
            </h4>
          </p>
      </div>
